...
const BookDetails = () => {
  ...
  return (
    <section className="min-h-screen">
      ...
      <div className="lg:max-w-4xl w-full lg:mx-auto bg-gradient-to-tr from-accent to-white rounded-xl shadow-md my-5 md:my-8">
        <div className="flex flex-col gap-2">
          <div className="px-3 md:px-5 pt-3">
            <img
              src={bookDetails.image}
              alt={bookDetails.title}
              className="w-60 md:w-1/2 lg:w-1/3 rounded-lg object-cover"
            />
          </div>
          <div className="flex px-3 md:px-5 flex-col">
            <div>
              <h1 className="text-xl md:text-3xl font-bold text-accent mb-2">
                {bookDetails.title}
              </h1>
              ...
              <p className="font-medium whitespace-pre-line mb-1">
                Book Content:
              </p>

              <p className="mb-1 flex-wrap flex">{bookDetails.content}</p>
            </div>
            ...
            <button
              className={`btn border-none w-24 py-1 my-2 rounded
             ${
               quantity === 0
                  ...
                  >
                    ...
                    <div className="text-center z-10">
                      ...
                      <DatePicker
                        ...
                        name="returnDate"
                        className="border w-full focus:outline-none focus:ring-1 focus:ring-accent pl-4 py-2 cursor-pointer placeholder-accent text-accent rounded-xl"
                      />
                    </div>
                    ...
                    <input
                      ...
                      readOnly
                      required
                      className="pl-3 mb-2 py-2 rounded-xl w-full border border-accent bg-white text-accent placeholder-accent focus:outline-none focus:ring-1 focus:ring-accent"
                    ...
                    <button
                      type="submit"
                      className="w-full btn py-3 rounded-xl border-none text-lg bg-accent/80 hover:bg-accent font-medium"
                    >
                      Borrow Book
                    </button>
                  </form>
